...
<body>
	...
	<section class="section">
		<?php 
			...
			/*include "search.php";*/
			$query = "select toy_id, toyname, toyprice, toypicture, (select categoryname from category where category.category_id = assort.toycategory) as toycategory, toyage, toysex, page, discription from assort where toy_id=1013;"; 
		...
		<div class="gallery">
			<div class="big_pic">
				<img src="img/toys/nabor_doctora.jpg" id="expandedImg" style="width:100%">
			</div>

			<div class="small_pic"><img src="img/toys/nabor_doctora.jpg" alt="Набор доктора" style="width:100%" onclick="myFunction(this);" class="small-img"></div>
		</div>
		...
		<div class="similar-goods">
			...
			<div class="similar-goods-cards">
				...
				$query = "select * from `assort` where toycategory = 9"; 
				$result = mysqli_query($induction, $query);
				$i = 1; 
