...
<body>
	...
	<section class="section">
		<?php 
			...
			/*include "search.php";*/
			$query = "select toy_id, toyname, toyprice, toypicture, (select categoryname from category where category.category_id = assort.toycategory) as toycategory, toyage, toysex, page, discription from assort where toy_id=1014;"; 
		...
		<div class="gallery">
			<div class="big_pic">
				<img src="img/toys/stol_risovaniye_apple.jpg" id="expandedImg" style="width:100%">
			</div>

			<div class="small_pic"><img src="img/toys/stol_risovaniye_apple.jpg" alt="Столик для рисования" style="width:100%" onclick="myFunction(this);" class="small-img"></div>
			<div class="small_pic"><img src="img/toys/stol-risovaniye_apple.jpg" alt="Столик для рисования" style="width:100%" onclick="myFunction(this);" class="small-img"></div>
			<div class="small_pic"><img src="img/toys/stol-risovaniye_apple2.jpg" alt="Столик для рисования" style="width:100%" onclick="myFunction(this);" class="small-img"></div>
			<div class="small_pic"><img src="img/toys/stol-risovaniye_apple4.jpg" alt="Столик для рисования" style="width:100%" onclick="myFunction(this);" class="small-img"></div>
		</div>
		...
		<div class="similar-goods">
			...
			<div class="similar-goods-cards">
				...
				$query = "select * from `assort` where toycategory = 11"; 
				$result = mysqli_query($induction, $query);
				$i = 1; 
