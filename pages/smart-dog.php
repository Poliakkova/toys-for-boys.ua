	...
	<section class="section">
		<?php 
			...
			/*include "search.php";*/
			$query = "select toy_id, toyname, toyprice, toypicture, (select categoryname from category where category.category_id = assort.toycategory) as toycategory, toyage, toysex, page, discription from assort where toy_id=1016;"; 
		...
		<div class="gallery">
			<div class="big_pic">
				<img src="img/toys/robot_smart_dog.jpg" id="expandedImg" style="width:100%">
			</div>

			<div class="small_pic"><img src="img/toys/robot_smart_dog.jpg" alt="Смарт Дог" style="width:100%" onclick="myFunction(this);" class="small-img"></div>
			<div class="small_pic"><img src="img/toys/robot_smart_dog2.jpg" alt="Смарт Дог" style="width:100%" onclick="myFunction(this);" class="small-img"></div>
			<div class="small_pic"><img src="img/toys/robot_smart_dog3.jpg" alt="Смарт Дог" style="width:100%" onclick="myFunction(this);" class="small-img"></div>
		</div>
