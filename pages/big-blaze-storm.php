	...
	<section class="section">
		<?php 
			...
			/*include "search.php";*/
			$query = "select toy_id, toyname, toyprice, toypicture, (select categoryname from category where category.category_id = assort.toycategory) as toycategory, toyage, toysex, page, discription from assort where toy_id=1009;"; 
		...
		<div class="gallery">
			<div class="big_pic">
				<img src="img/toys/blaze_storm.jpg" id="expandedImg" style="width:100%">
			</div>

			<div class="small_pic"><img src="img/toys/blaze_storm.jpg" alt="Бластер" style="width:100%" onclick="myFunction(this);" class="small-img"></div>
		</div>
